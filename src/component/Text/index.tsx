...
export default function Text () {
	...
	return (
		<Box component={"div"} id={"title"}
		     className={classNames( classes.root, "text-root", "MuiTypography-displayBlock" )}>
			<Typography variant={"h1"}
			            className={classNames( classes.title, classes.font, "text-title", "MuiTypography-displayBlock" )}>
			...
			<Typography variant={"body1"}
			            className={classNames( classes.sub, classes.font, "MuiTypography-displayBlock" )}>
